...
void set_eat_input(BOOL flag) { eat_input = flag; }

LONGLONG get_mouse_hook_proc_worst() { return mouse_hook_proc_worst; }
...
hook_event_t *get_hook_event() { return &hook_event; }

BOOL get_message(LPMSG lpMsg) { return GetMessageW(lpMsg, (HWND)-1, 0, 0); }
